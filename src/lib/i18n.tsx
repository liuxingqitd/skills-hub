...
const dictionaries: Record<Language, TranslationMap> = {
  zh: {
    ...
    "dashboard.usage.none": "未记录调用",
    "dashboard.usage.never": "从未使用",
    "dashboard.usage.meta": ({ total, count30d }) => `${total} 次调用 · 30 天 ${count30d}`,
    "dashboard.usage.title": ({ last }) => `最近使用：${last}`,
    ...
    "dashboard.usage.titleLabel": "调用统计",
    "dashboard.usage.total": "总调用",
    "dashboard.usage.lastUsed": "最近使用",
  ...
  en: {
    ...
    "dashboard.usage.none": "No calls recorded",
    "dashboard.usage.never": "Never used",
    "dashboard.usage.meta": ({ total, count30d }) => `${total} calls · 30d ${count30d}`,
    "dashboard.usage.title": ({ last }) => `Last used: ${last}`,
    ...
    "dashboard.usage.titleLabel": "Usage",
    "dashboard.usage.total": "Total calls",
    "dashboard.usage.lastUsed": "Last used",
